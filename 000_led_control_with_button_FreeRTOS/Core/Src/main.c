...
/* Definitions for readButtonState */
osThreadId_t readButtonStateHandle;
const osThreadAttr_t readButtonState_attributes = { .name = "readButtonState",
		.stack_size = 128 * 4, .priority = (osPriority_t) osPriorityNormal3, };
/* Definitions for ledFlashh */
osThreadId_t ledFlashhHandle;
const osThreadAttr_t ledFlashh_attributes = { .name = "ledFlashh", .stack_size =
